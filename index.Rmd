...
library(dplyr)
library(leaflet)
Tree_Locations <- read.csv("Oak_Coords_Taxa.csv")
...
```
### Cross Correlation to Look at Low Correlations: Example Series X224.
##### Series X224, a 
```{r message = FALSE}
...
QChron <- read.csv("https://raw.githubusercontent.com/geo511-2019/2019-geo511-project-gbream/master/data/QChron.csv")
